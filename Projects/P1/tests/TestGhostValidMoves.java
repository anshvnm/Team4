...
public class TestGhostValidMoves extends TestCase {
  ...
  public void testGhostValidMoves() throws FileNotFoundException {
    ...
    */
    ...
    assertTrue(!ghost.get_valid_moves().contains(left));
    assertTrue(ghost.get_valid_moves().contains(right));
    assertTrue(ghost.get_valid_moves().contains(up));
    assertTrue(ghost.get_valid_moves().contains(down));
 }
}